...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('kyc_app', '0003_kycbusiness_is_draft_kycworkflowstate_business_kyc_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_type', models.CharField(choices=[('INDIVIDUAL', 'Individual KYC Report'), ('BUSINESS', 'Business KYC Report')], max_length=20)),
                ...
                ('generated_by', models.CharField(help_text='User who generated the report', max_length=100)),
                ('generated_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('pdf_report', models.FileField(blank=True, null=True, upload_to='kyc_reports/')),
                ...
                ('business_kyc', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='kyc_reports', to='kyc_app.kycbusiness')),
                ('kyc_profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='kyc_reports', to='kyc_app.kycprofile')),
            ],
            options={
                'verbose_name': 'KYC Report',
                'verbose_name_plural': 'KYC Reports',
                'ordering': ['-generated_at'],
                'constraints': [models.CheckConstraint(condition=models.Q(('kyc_profile__isnull', False), ('business_kyc__isnull', False), _connector='OR'), name='either_individual_or_business_report_required')],
            },
        ),
    ]
